...
class TrainConfig:
    ...
    # If true, will log a small set of predicted vs ground-truth actions.
    log_action_samples: bool = False

    # If true, will log a sample prompt text (when available).
    log_prompt_samples: bool = False
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_full_finetune",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False),
        data=LeRobotTaskDataConfig(
            repo_id="/mnt/lerobot_data",
            base_config=DataConfig(prompt_from_task=True),
            prompt_key="prompt",
